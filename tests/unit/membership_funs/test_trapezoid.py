...
def test_regular_membership(regular_trapezoidal_mf: MFTrapezoidal, input, expected) -> None:
...
def test_left_shoulder_membership(left_trapezoidal_triangular_mf: MFTrapezoidal, input: float, expected: float) -> None:
...
def test_right_shoulder_membership(
    right_trapezoidal_triangular_mf: MFTrapezoidal, input: float, expected: float
) -> None:
    """Test Shoulder Triangle Membership Function."""
